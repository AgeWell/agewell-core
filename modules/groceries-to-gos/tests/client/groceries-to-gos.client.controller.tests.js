  ...
  describe('Groceries to gos Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (GroceriesToGosService) {
        // Set POST response
        $httpBackend.expectPOST('api/groceries-to-gos', sampleGroceriesToGoPostData).respond(mockGroceriesToGo);
        ...
        expect($state.go).toHaveBeenCalledWith('groceries-to-gos.view', {
      ...
      it('should set $scope.vm.error if error', function () {
        ...
        $httpBackend.expectPOST('api/groceries-to-gos', sampleGroceriesToGoPostData).respond(400, {
    ...
    describe('vm.save() as update', function () {
      ...
      it('should update a valid Groceries to go', inject(function (GroceriesToGosService) {
        // Set PUT response
        $httpBackend.expectPUT(/api\/groceries-to-gos\/([0-9a-fA-F]{24})$/).respond();
      ...
      it('should set $scope.vm.error if error', inject(function (GroceriesToGosService) {
        ...
        $httpBackend.expectPUT(/api\/groceries-to-gos\/([0-9a-fA-F]{24})$/).respond(400, {
          message: errorMessage
        });
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Groceries to go and redirect to Groceries to gos', function () {
        ...
        $httpBackend.expectDELETE(/api\/groceries-to-gos\/([0-9a-fA-F]{24})$/).respond(204);

        $scope.vm.remove();
        $httpBackend.flush();

        expect($state.go).toHaveBeenCalledWith('groceries-to-gos.list');
      });
